        ...
        >
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                <div className="space-y-2">
                 ...
                 <div className="col-span-1 md:col-span-2 mt-4 flex flex-col sm:flex-row gap-4">
                    <button type="submit" className="flex-1 py-4 rounded-[2rem] bg-violet-600 text-white font-bold text-lg tracking-wide shadow-lg shadow-violet-600/20 hover:bg-violet-700 transition-all hover:-translate-y-1">
                        Send Message
                    </button>
                    <a
                      href={whatsappUrl}
                      ...
                      className="flex-1 py-4 rounded-[2rem] bg-green-500 text-white font-bold text-lg tracking-wide shadow-lg shadow-green-500/20 hover:bg-green-600 transition-all hover:-translate-y-1 flex items-center justify-center gap-2"
                    >
            ...
            <div className="mt-14 pt-10 border-t border-black/5 dark:border-white/10 grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <a href="tel:+917828706954" className="text-slate-600 dark:text-slate-400 text-sm hover:text-violet-500 transition-colors">+91 78287 06954</a>
                </div>
                <div>
                    <h4 className="text-base font-bold text-slate-900 dark:text-white mb-2">Email</h4>
                    <a href="mailto:atultiwari997721@gmail.com" className="text-slate-600 dark:text-slate-400 text-sm hover:text-violet-500 transition-colors break-all">atultiwari997721@gmail.com</a>
                </div>
            </div>
